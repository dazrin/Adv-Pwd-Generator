...
2. This application will use lowercase characters by default; you may click on additional checkboxes if you wish for your password to contain the different character types specified.
3. Once you click the generate button, your new password will be displayed in the text field!

## Screenshot

![PasswordGeneratorScreenshot](https://i.imgur.com/5LvXGV1.png "A webpage featuring a password generator application")


## Credits

-  Credit goes to youtube channel WebDevSimplified for providing a tutorial on how to make this application.
